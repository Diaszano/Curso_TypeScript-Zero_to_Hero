...
Nesta aula aprendemos como lidar com Propriedades Estáticas no TypeScript.

Aqui temos o exemplos em TypeScript como se pode lida com Propriedades Estáticas em Classes
...
const funcionario_01 = new Funcionario('Lucas', 'Dias', 'Developer');
const funcionario_02 = new Funcionario('Luana', 'Dias', 'Estudante');
...
const funcionario_02 = new Funcionario_01('Luana', 'Dias', 'Estudante');
